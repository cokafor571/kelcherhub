...
function starterpack_setup() {
	...
	register_nav_menus( array(
        ...
        'menu-2' => esc_html__( 'Right Header', 'starterpack' ),
        'menu-3' => esc_html__( 'Mobile Menu', 'starterpack' ),
...
function starterpack_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sub Footer Widgets', 'starterpack' ),
        'id'            => 'sidebar-4',
        'description'   => esc_html__( 'Add sub footer widgets here.', 'starterpack' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
        'after_title'   => '</h2>',
...
function starterpack_scripts() {
    ...
    // Enque google fonts and font-awesome: Raleway
    ...
    if ( is_front_page() ) {
        wp_enqueue_script( 'yt-player-api', 'http://www.youtube.com/player_api', array( 'jquery' ) );
    }
...
/**
 * Enqueue youtube iframe api call
 */
    ...
    if ( wp_script_is( 'yt-player-api', 'done' ) ) { ?>
        ...
        <script id="yt-player-api-ready" type="text/javascript">
            ...
            function playFullscreen () {
                ...
                var requestFullScreen = document.getElementById("player").requestFullScreen || document.getElementById("player").mozRequestFullScreen || document.getElementById("player").webkitRequestFullScreen;

                if (requestFullScreen) {
                    requestFullScreen.bind( document.getElementById("player") )();
                }
            }
            ...
            function onPlayerReady(event) {
               ...
               player.setPlaybackQuality('hd1080'); // set playback quality
            ...
            function onPlayerStateChange(event) {
                if (event.data == YT.PlayerState.PLAYING && !done) {
                   // setTimeout(playFullscreen, 1000);
                   // done = true;
                }
...
/*
* Gravity Forms Enable Label Modification
*/
